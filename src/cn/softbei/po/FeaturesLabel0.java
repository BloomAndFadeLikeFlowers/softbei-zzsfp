...
public class FeaturesLabel0 implements Serializable {
	...
	public FeaturesLabel0() {
		super();
		// TODO Auto-generated constructor stub
	}

	public FeaturesLabel0(double label, String nsrid, double xxchange, double jxchange, double zzschange,
	...
	public String toString() {
		return label + "," + nsrid + "," + xxchange + "," + jxchange + "," + zzschange + "," + sfchange + "," + jxseCV
				+ "," + xxseCV + "," + zzsCV + "," + jxzfsezb + "," + xxzfsezb + "," + numOfFp + "," + numOfYf + ","
				+ jxnsrsimilarity + "," + xxnsrsimilarity + "," + onlyOutputOrInput + "," + jxxhwsimilarity;
	}
